...
- Think of $\lambda$ as a "budget" for coefficient spending
...
::: notes
Use finance framing: "We have a limited budget to allocate among predictors. 
Ridge says: use many predictors a little bit rather than a few predictors a lot."
This is why ridge keeps all predictors but dampens them.
Mention: we standardize because we don't want units to affect the budget!
:::
